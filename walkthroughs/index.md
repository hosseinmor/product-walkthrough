...
| --- | --- | --- | --- | --- | --- |
| JobVision | Candidate | Job Search (candidate area) | `partial` | — | Draft WT-2026-001 covers core logged-in search and selected filters; draft WT-2026-004 covers recommended-job surfaces and visible preference boundaries. Next: advanced filters, saved-search alerts, preference editing, notification semantics, and mobile/keyboard coverage. |
