...
| JobVision | Candidate | Job Details & Evaluation | `partial` | — | Saved Jobs empty state and safe save-entry boundaries are covered in draft WT-2026-005. Next: non-empty list, save/remove persistence, unavailable jobs, and accessibility follow-up in a disposable account. |
