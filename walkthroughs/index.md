...
| WT-2026-002 | JobVision Candidate / Application Submission flow (primary candidate area: Application Management; secondary: Resume Management and Job Details & Evaluation) | کارجوی واردشده در Production از صفحه اصلی؛ شناسایی معیارهای visible کامل‌بودن رزومه با تست کنترل‌شده، ناقص‌کردن موقت رزومه با اجازه صریح Owner، شروع Apply برای یک آگهی و بررسی کامل flow مسدودکننده یا recovery. مقدار تغییر‌یافته باید ثبت و در پایان برگردانده شود. خرید، پیام، حذف حساب و هر تغییر نامرتبط خارج از scope است. | `planned` | `not-assessed` | — | 2026-08-09 | اقدام‌های مجاز: تغییر حداقلی و برگشت‌پذیر رزومه و شروع Apply برای آشکارکردن gate رزومه. داده شخصی در evidence ثبت نشود؛ اگر محصول برخلاف انتظار اجازه ارسال واقعی داد، قبل از ایجاد Application برای کارفرمای واقعی توقف شود. |
