...
| JobVision | Candidate | Job Details & Evaluation | `not-assessed` | — | Complete the first bounded production walkthrough for logged-in Saved Jobs entry points, list states, navigation outcomes, and safe persistence boundaries. |
