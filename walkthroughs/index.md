...
| WT-2026-008 | Cando Salary / Product-wide audit (areas TBD) | کاربر لاگین‌شده در Production از Home؛ مسیرهای Team، Benchmark، Scenario، Job Profile و Settings با کنترل‌شدهٔ test data بررسی شد. | `draft` | `partial` | [evidence](walkthroughs/cando/salary/WT-2026-008/evidence.md) | 2026-08-09 | پوشش اصلی UI و رفتارهای ایجاد/ویرایش/حذف محدود؛ بعدی: role/error/empty/mobile و model/profile change کنترل‌شده. |
