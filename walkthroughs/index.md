...
| WT-2026-008 | Cando Salary Benchmark / Product-wide read-only audit (area TBD) | کاربر لاگین‌شده در Production از Home؛ بازبینی read-only مسیرها و قابلیت‌های قابل‌دسترسی، بدون ثبت، ارسال، ذخیره یا تغییر داده. | `planned` | `not-assessed` | — | 2026-08-09 | شروع از Home؛ coverage و gapها پس از استخراج ثبت می‌شوند. |
